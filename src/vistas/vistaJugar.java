 ...
 * @author paola
 */
public class vistaJugar extends javax.swing.JPanel {
    
    private Cliente usuario;
    private Juego jugado;

    /**
     * Creates new form vistaComprar
     */
    public vistaJugar(Cliente usuario) {
    ...
    private void initComponents() {
        ...
        fondoPanelTodosLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, fondoPanelTodosLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        fondoPanelTodosLayout.setVerticalGroup(
            fondoPanelTodosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(fondoPanelTodosLayout.createSequentialGroup()
                .addComponent(botonTodos, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
        ...
        botonJugar.setBackground(new java.awt.Color(153, 0, 255));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(28, 28, 28)
                .addComponent(tablaJuegos, javax.swing.GroupLayout.PREFERRED_SIZE, 597, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(86, 86, 86)
                .addComponent(botonJugar, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(49, 49, 49)
                        .addComponent(tablaJuegos, javax.swing.GroupLayout.PREFERRED_SIZE, 326, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(168, 168, 168)
    ...
    private void botonTodosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonTodosMouseClicked
        ...
        datos.setNumRows(0);
        for(Juego juego: this.usuario.getComprados()){
    ...
    private void botonJugarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonJugarMouseClicked
        ...
        if(this.jugado == null){
            ...
            if(usuario instanceof UserBasico){
            UserBasico user =new UserBasico();
            user=(UserBasico) usuario;
            user.jugar();
            usuario=user;
            }
            ...
            if(jugar==true){
                try{
                    final URI uri=new URI(this.jugado.getRutaVideo());
                    play(uri);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        this.jugado=this.usuario.buscarPorNombre(model.getValueAt(row, 0).toString());
